...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sample_array = samples_data.filter(sampleObj => sampleObj.id == sample);
    //  5. Create a variable that holds the first sample in the array.
    var sample_result = sample_array [0];
    console.log(sample_result);
    // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
    var otuIds=sample_result.otu_ids;
    console.log(otuIds);
    var otuLabels = sample_result.otu_labels;
    console.log(otuLabels);
    var sampleValues=sample_result.sample_values;
    ...
    var barLayout = {
      title: "Top Ten Bacterial Species Found in Belly Button",
      xaxis: {title: "Values"},
      yaxis: {title: "OTU_IDs"}
    };
...
var washFreq = sample_result.wfreq;
